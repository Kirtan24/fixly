...
// Page should not wrap Layout — App-level `Layout` already provides navbar/footer
...
function About() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      role: "CI/CD & Backend Engineer",
      photo: null,
    },
    {
      name: "Katharotiya Harsh",
      role: "Containerization & Kubernetes Engineer",
      photo: null,
    },
  ];
      ...
      <section className="bg-[#45573a] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto text-[#ebf2f3]">
            Connecting skilled professionals with customers looking for quality
            home services
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#0b0e11] mb-4">
              Our Mission
            </h2>
            <p className="text-lg text-[#727373] max-w-3xl mx-auto">
              To simplify home maintenance by connecting trusted professionals
              with customers who need quality services.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
            <Card className="p-6 hover:shadow-md transition-shadow duration-300 bg-white">
              ...
              <h3 className="text-xl font-semibold text-[#0b0e11] mb-2">
                Trusted Professionals
              </h3>
              <p className="text-[#727373]">
                We verify all our service providers to ensure quality and
                reliability.
              </p>
            </Card>
            ...
            <Card className="p-6 hover:shadow-md transition-shadow duration-300 bg-white">
              ...
              <p className="text-[#727373]">
                We stand behind our service providers with a satisfaction
                guarantee.
              </p>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-[#0b0e11] mb-6">
                Our Story
              </h2>
              <p className="text-[#0b0e11] mb-4">
                Founded in 2023, Fixly was born out of a simple idea: making
                home services easier and more reliable for everyone.
              </p>
              <p className="text-[#0b0e11] mb-4">
                We noticed that finding trustworthy home service professionals
                was often a frustrating experience. People spent hours
                searching, comparing, and worrying about quality and
                reliability.
              </p>
              <p className="text-[#0b0e11]">
                That's why we created Fixly - to connect skilled professionals
                with customers who need quality services, all in one reliable
                platform.
              </p>
            </div>
            <div className="md:w-1/2">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#727373] max-w-3xl mx-auto">
              Dedicated professionals working together to make home services
              better for everyone.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center max-w-xs">
                ...
                <h3 className="text-xl font-semibold text-[#0b0e11]">
                  {member.name}
                </h3>
